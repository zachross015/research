...
\usepackage{texmf/tex/latex/zross-style}
\usepackage{booktabs}
\usepackage{hyperref}
...
\addbibresource{texmf/bibtex/bib/global-bib.bib}
...
\part{Papers (Deprecated)}%
\label{prt:papers}

\paragraph{Preamble.} My initial method for retaining information from papers was to just write notes
explicitly out of the paper. While this helped to facilitate my understanding,
grouping the information in this manner seems to obfuscate any actual knowledge.
This method shall be deprecated henceforth, and any information gained from
papers will instead be categorized by topic and contributions to that topic.
