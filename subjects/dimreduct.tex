...
\TODO{Read
https://www.science.org/doi/full/10.1126/science.290.5500.2319?casa_token=whDQpzuoiBkAAAAA%3AYzbhWSgYlY6xTx399b0zDK7OLnSRkdrdKcp8024KOfx-nETbTfJXHeM80U06Phop5o5K7eSPI2Jm0g}
...
\cite{dimensionality-reduction-a-comparative}
highlights that linear methods often cannot handle complex, nonlinear data, and
provides the taxonomy in \reffig{drtaxonomy} for help in discovery of proper DR
methods. 

\begin{figure}
    \includegraphics[\width=\linewidth]{resources/drtaxonomy.png}
    \label{fig:drtaxonomy}
    \caption{Taxonomy of DR techniques}
\end{figure}
