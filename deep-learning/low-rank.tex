...
semi-unitarythe matrices will be approximately semi-unitary. Note that they can
...
\begin{figure}[t]
    ...
    \includegraphics[width=0.8\linewidth]{../images/hoyer.png}
\end{figure}
