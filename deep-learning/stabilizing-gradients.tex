\chapter{\sectioncite{stabilizing-gradients}}
...
\section{SVD and Orthogonality with Householder Reflectors}%
...
\begin{theorem}
    $\im{\cal{M}_1} = \bb(n)$ is the set of all $n \times n$ orthogonal matrices.
\end{theorem}
